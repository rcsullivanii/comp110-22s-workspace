...
def test_concat_one_empty() -> None:
    ...
    xs: list[int] = []
    ys: list[int] = [3, 4, 5]
    assert concat(xs, ys) == [3, 4, 5]


def test_concat_with_elements1() -> None:
    """Tests concatenating two lists."""
    xs: list[int] = [5, 6, 8]
    ys: list[int] = [3, 4, 5]
    assert concat(xs, ys) == [5, 6, 8, 3, 4, 5]


def test_concat_with_elements2() -> None:
    """Tests concatenating two lists."""
    xs: list[int] = [123456789]
    ys: list[int] = [2, 3]
    assert concat(xs, ys) == [123456789, 2, 3]